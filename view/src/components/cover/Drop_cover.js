...
const Container = styled.div`
    ...
    animation: show ${style_var.transition.fast};
    z-index: 11;
    position: fixed;
    width: 100vw;
    height: 100vh;
...
const Drop_cover = props => (
    <Container onDrop={props.drop}>
        <div className="icon">
            <svg
                viewBox="0 0 28 28"
                version="1.1"
        ...
        <div className="content">
            <FormattedMessage id="drop_cover.drop" defaultMessage="DROP" />
            <br />
            <FormattedMessage id="drop_cover.here" defaultMessage="here" />
        </div>
        <div id="cover" onDragLeave={props.dragLeave} />
    </Container>
);
